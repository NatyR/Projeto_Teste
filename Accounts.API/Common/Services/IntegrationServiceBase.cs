...
namespace Accounts.API.Common.Services
{
        ...
        public virtual HttpResponseDto Execute(Func<HttpResponseDto> func, string reference = null, string referenceType = null)
        {
            ...
            catch (Exception e)
            {
                ...
                if (e.InnerException is TaskCanceledException)
                {
                    ...
                    {
                        throw new ServiceUnavailableException("Não foi possível processar sua solicitação no momento. Por favor, tente novamente mais tarde. não foi possivel converter json 1");
                    }
